...
module.exports = {
    ...
    parse: function parse(buffer) {
        ...
        var type = lines[0].indexOf('HTTP') === 0 ? 'device' : lines[0].substr(0, lines[0].indexOf(' '));
    ...
    , wrap: function wrap(socket) {
        ...
        socket.discover = function (type, data, addr) {
            ...
            if (type.indexOf('HTTP') !== 0) type = type + " * HTTP/1.1";
            ...
            return new Promise((resolve, reject) => {
                socket.send(msg, 0, msg.length, addr.port, addr.address, function (err) {
